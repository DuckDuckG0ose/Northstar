...
from modules import maximize_command_prompt, boostdiscord, webbrowser, center
import json
...
def selectionmenu():
    while True:
        ...
        print(f'\n \n')
        print(center(crayons.blue("[1.] SoftReboot                                                  [2.] Restore Point Center                                             [3.] Debloat")))
        print(center("Use this if your pc has been                                     Need to create or restore to a restore point?                         Removes bloatware from your PC"))
        print(center("running for a while and you want a boost                         Use this!                                                             In order to speed it up"))
        print(f'\n \n')
        print(center(crayons.blue("[4.] Powerplan                                                   [5.] Boost Discord")))
        print(center("Not reccomended using on a laptop                                Using this tweak makes your Discord"))
        print(center("Boosts your pc's preformance by using out custom power plan      client use less resources and goes brrrr"))
        print(f'\n \n')
        try:
